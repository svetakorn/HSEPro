    ...
    <!-- Sweet alert -->
    <link rel="stylesheet" type="text/css" href="<?php echo $BASE; ?>/ui/css/plugins/sweetalert/sweetalert.css">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                           ...
                           <input type="text" name="id" hidden value="<?php echo $stInfo['id']; ?>">
                           <input type="text" name="fullname" hidden value="<?php echo $stInfo['fullname']; ?>">
                           <input type="text" name="year" hidden value="<?php echo $stInfo['year']; ?>">
                           <input type="text" name="program" hidden value="<?php echo $stInfo['program']; ?>">
...
<!-- Sweet alert -->
<script src="<?php echo $BASE; ?>/ui/js/plugins/sweetalert/sweetalert.min.js"></script>
<!-- Toastr script -->
